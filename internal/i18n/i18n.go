...
var En = Messages{
	...
	HelpBar:              "  ↑↓ nav │ space multi-select │ enter details │ l log 1 │ L log N │ / grep │ f tail │ E export │ x shell │ C prune │ s stop │ R restart │ S stress │ M map │ r refresh │ ? help │ q quit",
	TableHost:            "HOST",
	TableName:            "NAME",
	TableState:           "STATE",
...
var Pt = Messages{
	...
	HelpBar:              "  ↑↓ nav │ space selec. mult. │ enter detalhe │ l log 1 │ L log N │ / buscar log │ f seguir │ E export │ x shell │ C faxina │ s stop │ R restart │ S stress │ M map │ r refresh │ ? ajuda │ q sair",
	TableHost:            "HOST",
	TableName:            "NOME",
	TableState:           "ESTADO",
	...
	SecRootUser:          "Container está rodando suas rotinas internas com o usuário root",
